...
\begin{codebox}[src/polynomial.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
"""
...
\begin{codebox}[src/general\_alg.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[src/polynomial\_sparse.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[src/basic\_polynomial\_operations/polynomial\_addition.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[src/dict\_linked\_list.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[src/polynomial\_dense.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
convert to and from \texttt{PolynomialSparse\_\string{I\string}} and
...
\begin{codebox}[src/basic\_polynomial\_operations/polynomial\_multiplication.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[test/polynomial\_mod\_p\_test.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[src/polynomial\_factorization/factor.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[test/factorization\_test.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
...
\begin{codebox}[test/stress\_test.jl]
    \begin{Verbatim}[numbers=left,xleftmargin=5mm]
using Pkg
Pkg.activate(".")
